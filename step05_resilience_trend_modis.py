...
if __name__=='__main__':
    ...
    # load ar1 data
    tac = np.load(current_dir+'/2_Output/spatial_resilience/ar1_4yr_kndvi_modis_sg_rolling.npy')
    ...
    outpath = current_dir+'/2_Output/spatial_resilience/resilience_trend_modis.npy'
