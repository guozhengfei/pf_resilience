...
if __name__=='__main__':
    ...
    # load ar1 data
    tac = np.load(current_dir+'/2_Output/spatial_resilience/ar1_5yr_kndvi_modis_sg_rolling_v0.npy')
    ...
    outpath = current_dir+'/2_Output/spatial_resilience/resilience_trend_modis_nonSG.npy'
