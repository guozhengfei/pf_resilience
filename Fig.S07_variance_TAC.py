...
if __name__ == '__main__':
    ...
    axs[0].set_ylim([-0.00023,0.00023])
    ...
    axs[1].bar(0, np.nanmean(trend_10), yerr=np.nanstd(trend_10) * 0.05, color='#4393c3', width=0.3, ec='k', hatch='//',
               alpha=0.7)
    axs[1].bar(0.3, np.nanmean(trend_23), yerr=np.nanstd(trend_23) * 0.05, color='#4393c3', width=0.3, ec='k',
               alpha=0.7)
    ...
    axs[1].bar(1, np.nanmean(trend_10), yerr=np.nanstd(trend_10) * 0.05, color='#4393c3', width=0.3, ec='k', hatch='//',
               alpha=0.7)
    axs[1].bar(1.3, np.nanmean(trend_23), yerr=np.nanstd(trend_23) * 0.05, color='#4393c3', width=0.3, ec='k',
               alpha=0.7)
    ...
    axs[1].bar(2, np.nanmean(trend_10), yerr=np.nanstd(trend_10) * 0.05, color='#4393c3', width=0.3, ec='k', hatch='//',
               alpha=0.7)
    axs[1].bar(2.3, np.nanmean(trend_23), yerr=np.nanstd(trend_23) * 0.05, color='#4393c3', width=0.3, ec='k',
               alpha=0.7)
    ...
    axs[1].bar(3, np.nanmean(trend_10), yerr=np.nanstd(trend_10) * 0.05, color='#4393c3', width=0.3, ec='k', hatch='//',
               alpha=0.7)
    axs[1].bar(3.3, np.nanmean(trend_23), yerr=np.nanstd(trend_23) * 0.05, color='#4393c3', width=0.3, ec='k',
               alpha=0.7)
    ...
    axs[1].bar(4, np.nanmean(trend_10), yerr=np.nanstd(trend_10) * 0.05, color='#4393c3', width=0.3, ec='k', hatch='//',
               alpha=0.7)
    axs[1].bar(4.3, np.nanmean(trend_23), yerr=np.nanstd(trend_23) * 0.05, color='#4393c3', width=0.3, ec='k',
               alpha=0.7)
    ...
    fig.tight_layout()
    figToPath = current_dir + '/4_Figures/Fig01_resilience_patterns_temporal_variance'
