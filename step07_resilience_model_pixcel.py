...
if __name__ == '__main__':
    ...
    array = np.stack(
        [vpd_annual_data, srad_annual_data, pr_annual_data, tmean_annual_data, sT_annual_data, sm_annual_data,
         alt_annual_data, co2_2d, ndvi_annual_data, gsl_annual_data,lai_annual_data,tac_annual_data
    ...
    with mp.Pool(6) as pool:
        results = list(pool.map(model_validate, divided_arrays))
    results_array = np.array(results)
    output_file = current_dir+'/2_Output/Temporal/Temporal_r_shap_obs_pre.npy'
