...
if __name__ == '__main__':
    ...
    # plt.figure()
    # plt.plot(np.nanmean(ser,axis=0))
    ...
    for yr in range(yr_num):
        ...
        # make all non-growing season is nan
        Evi_sea[:,:7-3] = np.nan
        Evi_sea[:, -7-3:] = np.nan
    ...
    output_file = current_dir + '/2_Output/spatial_resilience/ar1_5yr_kndvi_modis_sg_rolling_GS.npy'
