...
if __name__ == '__main__':
    ...
    axs[0].plot(time_label_modis, tac_i_yr - tac_i_yr[0], color=cl, lw=2)
    axs[0].fill_between(time_label_modis, tac_i_yr - tac_i_yr[0] + sd, tac_i_yr - tac_i_yr[0] - sd, color=cl, alpha=0.3)
    mean_val_modis = np.nanmean(tac2, axis=0)[:-1]
    se = np.nanstd(tac2, axis=0)[:-1] / 10
