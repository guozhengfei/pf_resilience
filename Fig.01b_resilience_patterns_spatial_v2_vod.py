...
if __name__ == '__main__':
    ...
    fig.tight_layout()
    figToPath = current_dir + '/4_Figures/Fig01_resilience_hist_v2_vod'
    ...
    fig.tight_layout()
    figToPath = current_dir + '/4_Figures/Fig01_resilience_patterns_spatialal_v2_vod'
    ...
    output_path = current_dir + '/4_Figures/trend_2000_2007_vod.tif'
    ...
    output_path = current_dir + '/4_Figures/trend_2008_2022_vod.tif'
    with rasterio.open(output_path, 'w', driver='GTiff',
    ...
    output_path = current_dir + '/4_Figures/trend_difference_vod.tif'
    with rasterio.open(output_path, 'w', driver='GTiff',
