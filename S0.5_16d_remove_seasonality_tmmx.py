...
if __name__ == '__main__':
    ...
    pr01 = tf.imread(Data_folder + 'tmmx_1982_2022-0000000000-0000000000.tif')
    pr02 = tf.imread(Data_folder + 'tmmx_1982_2022-0000000000-0000002304.tif')
    ...
    np.save(current_dir+'/1_Input/data for drivers/tmmx_16d_rm_seasonality.npy', EVI_res)