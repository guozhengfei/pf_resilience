...
if __name__ == '__main__':
    ...
    tac = ar1_5yr_modis
    tac[tac == 0] = np.nan;
    tac_yr = tac.reshape(tac.shape[0], 22, 12)
    ...
    time_label_modis = np.linspace(2002,2020,18)
    ...
    #
    mean_val_modis = np.nanmedian(tac2, axis=0)
    ...
    fig.tight_layout()
    figToPath = current_dir+'/4_Figures/Fig01_resilience_patterns_temporal_brdf'
    ...
    # temporal_df.to_csv(current_dir + '/4_Figures/Fig.1/Fig01_temporal_patterns.csv', index=False)
    ...
    pft_trends_df.to_csv(current_dir + '/4_Figures/Fig.1/Fig01_pft_trends_brdf.csv', index=False)
    ...
    cdsi_trends_df.to_csv(current_dir + '/4_Figures/Fig.1/Fig01_cdsi_trends_brdf.csv', index=False)